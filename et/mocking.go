...
func RunMiddleware(enabled bool) (_ MockOption) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/et/mocking.go#L20-L24
...
func MockEndpoint[T any](originalEndpoint T, mock T, opts ...MockOption) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/et/mocking.go#L52-L72
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func MockService[T any](serviceName string, mock T, opts ...MockOption) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/et/mocking.go#L98-L109
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
