...
//
// For documentation on how to use middleware in KhulnaSoft see https://khulnasoft.com/docs/develop/middleware.
package middleware
...
func (*Request) WithContext(ctx context.Context) (_ Request) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/middleware/middleware.go#L44-L48
...
func (*Request) Context() (_ context.Context) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/middleware/middleware.go#L51-L53
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}

// Data returns information about the request.
func (*Request) Data() (_ *khulnasoft.Request) {
	// KhulnaSoft will provide an implementation to this function at runtime, we do not expose
	// the implementation in the API contract as it is an implementation detail, which may change
	// between releases.
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/middleware/middleware.go#L56-L58
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
type Response struct {
	...
	//
	// If zero is returned from middleware, KhulnaSoft will choose an appropriate status code based
	// status code depending on the type of error being returned (or 200 for success).
	//
	// If a non-zero value is returned from a middleware, KhulnaSoft will use that status code
...
func NewRequest(ctx context.Context, data *khulnasoft.Request) (_ Request) {
	// KhulnaSoft will provide an implementation to this function at runtime, we do not expose
	// the implementation in the API contract as it is an implementation detail, which may change
	// between releases.
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/middleware/middleware.go#L99-L104
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
