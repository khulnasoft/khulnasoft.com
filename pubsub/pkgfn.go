...
// NewTopic is used to declare a Topic. KhulnaSoft will use static
...
// in a compiler error.
//
// The topic name must be unique within an KhulnaSoft application. Topic names must be defined
...
func NewTopic[T any](name string, cfg TopicConfig) (_ *Topic[T]) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/pubsub/pkgfn.go#L39-L41
