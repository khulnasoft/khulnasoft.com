...
// to KhulnaSoft's static analysis restrictions that apply to MyTopic.
...
// without being subject to KhulnaSoft's typical static analysis
...
func TopicRef[P TopicPerms[T], T any](topic *Topic[T]) (_ P) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/pubsub/refs.go#L47-L49
