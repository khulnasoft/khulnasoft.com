...
func NewSubscription[T any](topic *Topic[T], name string, cfg SubscriptionConfig[T]) (_ *Subscription[T]) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/pubsub/subscription.go#L63-L247
...
func (*Subscription[T]) Meta() (_ SubscriptionMeta[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/pubsub/subscription.go#L264-L270
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Subscription[T]) Config() (_ SubscriptionConfig[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/pubsub/subscription.go#L274-L276
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func MethodHandler[T, SvcStruct any](handler func(s SvcStruct, ctx context.Context, msg T) error) (_ func(ctx context.Context, msg T) error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/pubsub/subscription.go#L320-L327
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
