...
func (PathParams) Get(name string) (_ string) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/request.go#L130-L138
...
func (Tags) Has(tag string) (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/request.go#L217-L219
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
