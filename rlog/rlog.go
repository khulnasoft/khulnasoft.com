// Package rlog provides a simple logging interface which is integrated with KhulnaSoft's
// inbuilt distributed tracing.
//
// For more information about logging inside KhulnaSoft applications see https://khulnasoft.com/docs/observability/logging.
package rlog
...
func (Ctx) Debug(msg string, keysAndValues ...any) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/rlog/rlog.go#L79-L83
...
func (Ctx) Info(msg string, keysAndValues ...any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/rlog/rlog.go#L88-L92
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (Ctx) Warn(msg string, keysAndValues ...any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/rlog/rlog.go#L97-L101
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (Ctx) Error(msg string, keysAndValues ...any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/rlog/rlog.go#L106-L110
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (Ctx) With(keysAndValues ...any) (_ Ctx) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/rlog/rlog.go#L115-L125
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
