...
//
// When all active tasks and [Handler.Shutdown] calls have completed, KhulnaSoft begins shutting down
// infrastructure resources. KhulnaSoft automatically closes all open database connections, cache connections,
...
type Handler interface {
	// Shutdown is called by KhulnaSoft when the graceful shutdown process is initiated.
	//
	...
	// and KhulnaSoft will wait for all Handlers to return before closing
