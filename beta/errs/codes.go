...
const (
	...
	//
	// KhulnaSoft will generate this error code when cancellation is requested.
	Canceled ErrCode = 1
	...
	//
	// KhulnaSoft will generate this error code in the above two mentioned cases.
	Unknown ErrCode = 2
	...
	//
	// KhulnaSoft will generate this error code if the request data cannot be parsed.
	...
	//
	// KhulnaSoft will generate this error code when the deadline is exceeded.
	DeadlineExceeded ErrCode = 4

	// NotFound means some requested entity (e.g., file or directory) was
	// not found.
	//
	// KhulnaSoft will not generate this error code.
	NotFound ErrCode = 5
	...
	//
	// KhulnaSoft will generate this error code in out-of-memory and server overload
	...
	//
	// KhulnaSoft will generate this error code when an endpoint does not exist.
	...
	//
	// KhulnaSoft will generate this error code in several internal error conditions.
	Internal ErrCode = 13
	...
	// Aborted, and Unavailable.
	//
	// KhulnaSoft will generate this error code in aubrupt shutdown of a server process
	...
	//
	// KhulnaSoft will generate this error code when the authentication metadata
