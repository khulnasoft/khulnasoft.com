...
func NewCounter[V Value](name string, cfg CounterConfig) (_ *Counter[V]) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/pkgfn.go#L7-L9
...
func NewCounterGroup[L Labels, V Value](name string, cfg CounterConfig) (_ *CounterGroup[L, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/pkgfn.go#L16-L18
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func NewGauge[V Value](name string, cfg GaugeConfig) (_ *Gauge[V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/pkgfn.go#L22-L24
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func NewGaugeGroup[L Labels, V Value](name string, cfg GaugeConfig) (_ *GaugeGroup[L, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/pkgfn.go#L31-L33
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
