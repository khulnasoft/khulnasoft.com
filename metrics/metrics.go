...
func (*Counter[V]) Increment() {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/metrics.go#L36-L41
...
func (*Counter[V]) Add(delta V) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/metrics.go#L45-L53
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*CounterGroup[L, V]) With(labels L) (_ *Counter[V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/metrics.go#L71-L74
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Gauge[V]) Set(val V) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/metrics.go#L111-L116
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Gauge[V]) Add(val V) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/metrics.go#L118-L123
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*GaugeGroup[L, V]) With(labels L) (_ *Gauge[V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/metrics/metrics.go#L136-L139
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
