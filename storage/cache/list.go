...
func NewListKeyspace[K any, V BasicType](cluster *Cluster, cfg KeyspaceConfig) (_ *ListKeyspace[K, V]) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L25-L32
...
func (*ListKeyspace[K, V]) With(opts ...WriteOption) (_ *ListKeyspace[K, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L46-L48
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L57-L59
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) PushLeft(ctx context.Context, key K, values ...V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L73-L88
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) PushRight(ctx context.Context, key K, values ...V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L102-L117
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) PopLeft(ctx context.Context, key K) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L123-L140
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) PopRight(ctx context.Context, key K) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L146-L162
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Len(ctx context.Context, key K) (length int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L169-L180
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Trim(ctx context.Context, key K, start, stop int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L192-L203
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Set(ctx context.Context, key K, idx int64, val V) (err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L213-L225
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Get(ctx context.Context, key K, idx int64) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L235-L249
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Items(ctx context.Context, key K) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L256-L258
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) GetRange(ctx context.Context, key K, start, stop int64) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L268-L270
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) InsertBefore(ctx context.Context, key K, needle, newVal V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L302-L318
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) InsertAfter(ctx context.Context, key K, needle, newVal V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L328-L344
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) RemoveAll(ctx context.Context, key K, needle V) (removed int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L353-L366
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) RemoveFirst(ctx context.Context, key K, count int64, needle V) (removed int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L375-L395
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) RemoveLast(ctx context.Context, key K, count int64, needle V) (removed int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L404-L424
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*ListKeyspace[K, V]) Move(ctx context.Context, src, dst K, fromPos, toPos ListPos) (moved V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/list.go#L442-L460
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
