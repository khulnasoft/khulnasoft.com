...
//
// For more information see https://khulnasoft.com/docs/develop/caching
package cache
...
// The eviction policies KhulnaSoft supports.
// See https://redis.io/docs/manual/eviction/#eviction-policies for more information.
const (
...
type KeyspaceConfig struct {
	...
	//
	// When updating the expiration time KhulnaSoft always
...
func (*OpError) Error() (_ string) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/cache.go#L120-L122
...
func (*OpError) Unwrap() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/cache.go#L124-L126
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func ExpireIn(dur time.Duration) (_ ExpiryFunc) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/cache.go#L167-L169
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func ExpireDailyAt(hour, minute, second int, loc *time.Location) (_ ExpiryFunc) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/cache.go#L173-L183
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
