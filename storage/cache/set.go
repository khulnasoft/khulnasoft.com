...
func NewSetKeyspace[K any, V BasicType](cluster *Cluster, cfg KeyspaceConfig) (_ *SetKeyspace[K, V]) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L17-L24
...
func (*SetKeyspace[K, V]) With(opts ...WriteOption) (_ *SetKeyspace[K, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L38-L40
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L49-L51
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Add(ctx context.Context, key K, values ...V) (added int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L60-L75
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Remove(ctx context.Context, key K, values ...V) (removed int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L85-L100
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) PopOne(ctx context.Context, key K) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L107-L124
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Pop(ctx context.Context, key K, count int) (values []V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L132-L149
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Contains(ctx context.Context, key K, val V) (contains bool, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L156-L167
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Len(ctx context.Context, key K) (length int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L174-L185
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Items(ctx context.Context, key K) (values []V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L192-L204
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) ItemsMap(ctx context.Context, key K) (values map[V]struct{}, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L211-L224
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Diff(ctx context.Context, keys ...K) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L242-L249
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) DiffMap(ctx context.Context, keys ...K) (_ map[V]struct{}, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L254-L261
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) DiffStore(ctx context.Context, destination K, keys ...K) (size int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L282-L301
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Intersect(ctx context.Context, keys ...K) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L313-L320
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) IntersectMap(ctx context.Context, keys ...K) (_ map[V]struct{}, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L325-L332
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) IntersectStore(ctx context.Context, destination K, keys ...K) (size int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L354-L371
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Union(ctx context.Context, keys ...K) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L382-L389
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) UnionMap(ctx context.Context, keys ...K) (_ map[V]struct{}, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L394-L401
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) UnionStore(ctx context.Context, destination K, keys ...K) (size int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L424-L440
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) SampleOne(ctx context.Context, key K) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L447-L461
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Sample(ctx context.Context, key K, count int) (values []V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L469-L490
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) SampleWithReplacement(ctx context.Context, key K, count int) (values []V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L498-L519
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*SetKeyspace[K, V]) Move(ctx context.Context, src, dst K, val V) (moved bool, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/set.go#L528-L541
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
