...
func NewStructKeyspace[K, V any](cluster *Cluster, cfg KeyspaceConfig) (_ *StructKeyspace[K, V]) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L11-L27
...
func (*StructKeyspace[K, V]) With(opts ...WriteOption) (_ *StructKeyspace[K, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L40-L42
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) Get(ctx context.Context, key K) (_ V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L48-L50
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) Set(ctx context.Context, key K, val V) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L55-L57
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) SetIfNotExists(ctx context.Context, key K, val V) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L63-L65
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) Replace(ctx context.Context, key K, val V) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L71-L73
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) GetAndSet(ctx context.Context, key K, val V) (oldVal V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L79-L81
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) GetAndDelete(ctx context.Context, key K) (oldVal V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L87-L89
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*StructKeyspace[K, V]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/cache/struct.go#L98-L100
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
