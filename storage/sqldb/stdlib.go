...
//
// The connection string should be used with the "khulnasoft" driver name:
//
//	connStr := sqldb.RegisterStdlibDriver(myDB)
//	db, err := sql.Open("khulnasoft", connStr)
//
...
func RegisterStdlibDriver(db *Database) (_ string) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/stdlib.go#L22-L31
