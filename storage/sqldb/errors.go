...
import (
	"khulnasoft.com/storage/sqldb/sqlerr"
)
...
func ErrCode(err error) (_ sqlerr.Code) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/errors.go#L16-L22
...
func (*Error) Error() (_ string) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/errors.go#L78-L80
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Error) Unwrap() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/errors.go#L82-L84
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
