...
//
// KhulnaSoft uses static analysis to identify databases and their configuration,
...
// in a compiler error.
//
// The database name must be unique within the KhulnaSoft application. Database names must be defined
...
func NewDatabase(name string, config DatabaseConfig) (_ *Database) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L21-L23
...
func Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L42-L44
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L50-L52
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L57-L59
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func Begin(ctx context.Context) (_ *Tx, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L64-L66
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func Commit(tx *Tx) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L72-L74
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func Rollback(tx *Tx) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L80-L82
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func ExecTx(tx *Tx, ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L88-L90
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func QueryTx(tx *Tx, ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L96-L98
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func QueryRowTx(tx *Tx, ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L104-L106
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func Named(name constStr) (_ *Database) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/pkgfn.go#L116-L118
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
