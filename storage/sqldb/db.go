...
func (*Database) Stdlib() (_ *sql.DB) {
	...
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L61-L94
...
func (*Database) Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L167-L203
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Database) Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L209-L247
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Database) QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L252-L288
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Database) Begin(ctx context.Context) (_ *Tx, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L293-L316
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
// that the KhulnaSoft application is expecting a driver that is supported.
//
// At some point in the future where KhulnaSoft adds support for a different database driver
...
func Driver[T SupportedDrivers](db *Database) (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L328-L335
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
// that the KhulnaSoft application is expecting a driver that is supported.
//
// At some point in the future where KhulnaSoft adds support for a different
...
func DriverConn[T SupportedDriverConns](conn *sql.Conn, f func(driverConn T) error) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/db.go#L358-L371
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
