// Package sqldb provides KhulnaSoft services direct access to their databases.
//
// For the documentation on how to use databases within KhulnaSoft see https://khulnasoft.com/docs/develop/databases.
package sqldb
...
func (*Tx) Commit() (_ error) {
	...
	//
	//	https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L42-L42
...
func (*Tx) Rollback() (_ error) {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L47-L47
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Tx) Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L93-L95
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Tx) Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L130-L164
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Tx) QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L166-L200
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Rows) Close() {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L213-L213
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Rows) Scan(dest ...interface{}) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L220-L220
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Rows) Err() (_ error) {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L226-L226
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Rows) Next() (_ bool) {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L236-L236
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Row) Scan(dest ...interface{}) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L250-L263
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
...
func (*Row) Err() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/khulnasoft/khulnasoft/blob/v1.41.9/runtimes/go/storage/sqldb/sqldb.go#L265-L270
	doPanic("khulnasoft apps must be run using the khulnasoft command")
	return
}
